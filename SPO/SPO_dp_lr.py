        ...
        for epoch in range(num_epochs):
            ...
            for kn_nr in knapsack_nrs:
                ...
                if self.degree ==2:
                    ...
                    reg = calculate_profit_from_items(sol_true,V_true) - calculate_profit_from_items(sol_pred,V_true)
                    grad = reg*grad
                self.time +=t
                    ...
                    if cnt % 20 == 0:
                        ...
                        if self.verbose:
                            if validation:
                                ...
                                print('Epoch[{}/{}]::{}, loss(train): {:.6f}, regret(train): {:.2f}, loss(validation): {:.6f}, regret(validation): {:.2f} , regret(test): {:.2f}'.format(epoch+1,
                                    num_epochs, cnt, dict_train['loss'], dict_train['regret_full'],dict_validation['loss'],dict_validation['regret_full'],dict_test['regret_full']  ))
                            else:
