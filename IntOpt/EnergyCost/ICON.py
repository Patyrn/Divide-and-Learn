...
def data_reading(filename):
    ...
    return {"nr_machines":nbMachines,
                "nr_tasks":nbTasks,"nr_resources":nbResources,
                "MC":MC,
                "U":U,
                "D":D,
                "E":E,
...
class Gurobi_ICON:
    ...
    def __init__(self,nr_machines,nr_tasks,nr_resources,MC,U,D,E,L,P,idle,up,down,q,reset,presolve, relax=False,
        verbose=False,warmstart=False,method=-1,**h):
        self.nbMachines  = nr_machines
        self.nbTasks = nr_tasks
        self.nbResources = nr_resources
        self.MC = MC
        self.U =  U
        self.D = D
        self.E = E
